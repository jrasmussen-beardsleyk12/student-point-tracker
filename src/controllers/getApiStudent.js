module.exports = {
  ...
  async logic(params, context) {
    let search = await context.database.searchStudent(params.query, params.page);

    if (!search.ok) {
      const sso = new context.sso();

      return sso.notOk().addContent(search)
    ...
    sso.buildLink(`${context.config.SERVER_URL}/api/student`, search.pagination.page, params);
